...
export const getStoresClient = {
  ...
  createStoresDetail: async () => Builder.POST_Cashed<MorabaaItemSolutionDomainInterfacesIStore>({ root: "items", url: `/api/v1/stores/details` }),
};
export const getStoresOfbusinessByBusinessIdPagenatedClient = Builder.Offset_Load_Cashed<
  LoadStoresOfbusinessByBusinessIdParams,
  LoadStoresOfbusinessByBusinessIdResponse[]
>({
  getUrl: ({ businessId }) => {
