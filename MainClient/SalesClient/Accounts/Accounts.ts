...
export const getAccountsClient = {
  ...
  AccountsSearch: async (params: AccountsSearchParams) => Builder.GET_Cashed({ root: "sales", url: `/api/v1/accounts/search`, params }),
  ...
  AccountsCount: async (params: AccountsCountParams) => Builder.GET_Cashed({ root: "sales", url: `/api/v1/accounts/count`, params }),
  ...
  createAccountsGet_many: async () => Builder.POST_Cashed<SalesReportAPIEntitiesAccount>({ root: "sales", url: `/api/v1/accounts/get-many` }),
};
export const getAccountsPagenatedClient = Builder.Offset_Load_Cashed<LoadAccountsParams, LoadAccountsResponse[]>({ url: `/api/v1/accounts` });
export const getAccountsOfbusinessPendingByBusinessIdPagenatedClient = Builder.Offset_Load_Cashed<
  LoadAccountsOfbusinessPendingByBusinessIdParams,
  LoadAccountsOfbusinessPendingByBusinessIdResponse[]
>({
  getUrl: ({ businessId }) => {
