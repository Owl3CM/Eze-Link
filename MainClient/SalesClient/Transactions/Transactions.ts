...
export const getTransactionsExpensesByBusinessIdPagenatedClient = Builder.Offset_Load_Cashed<
  LoadTransactionsExpensesByBusinessIdParams,
  LoadTransactionsExpensesByBusinessIdResponse[]
>({
  getUrl: ({ businessId }) => {
