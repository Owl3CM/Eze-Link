...
export const getBusinessTransactionsV2Client = {
  BusinesstransactionsV2: async () => Builder.GET_Cashed({ root: "sales", url: `/api/v2/businesstransactions` }),
...
export const getBusinesstransactionsOfbusinessV2ByBusinessIdPagenatedClient = Builder.Offset_Load_Cashed<
  LoadBusinesstransactionsOfbusinessV2ByBusinessIdParams,
  LoadBusinesstransactionsOfbusinessV2ByBusinessIdResponse[]
>({
  getUrl: ({ businessId }) => {
