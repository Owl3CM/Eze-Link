import Builder from "../../Builder";  
    ...
    delete_Offer: async ({id}:delete_OfferParams) => 
                 Builder.DELETE({root:"items",url:"/api/v1/offers/${id}" }),
 } 
                     export const getOffersPagenatedClient = Builder.Offset_Load_Cashed<LoadOffersParams,LoadOffersResponse>
                                ({url:"/api/v1/offers"})