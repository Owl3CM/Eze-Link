import Builder from "../../Builder";  
    ...
    delete_ItemsUpdatesV2: async ({id}:delete_ItemsUpdatesV2Params) => 
                 Builder.DELETE({root:"items",url:"/api/v2/items/updates/${id}" }),
    ...
    createItemsPendingAcceptV2: async ({id, createItemsPendingAcceptV2}:createItemsPendingAcceptV2Params) => 
                 Builder.POST_Cashed<MorabaaItemSolutionDomainInterfacesIItem>({root:"items",url:"/api/v2/items/pending/${id}/accept", body: createItemsPendingAcceptV2 }),
    ...
    ItemsOfownerCount: async (params:ItemsOfownerCountParams) => 
                 Builder.GET_Cashed({root:"items",url:"/api/v1/items/ofowner/count", params }),
    ...
    ItemsById: async ({id}:ItemsByIdParams) => 
                 Builder.GET_Cashed<MorabaaItemSolutionDomainInterfacesIItem>({root:"items",url:"/api/v1/items/${id}" }),

    ItemsLanding: async () => 
                 Builder.GET_Cashed<MorabaaItemSolutionRESTAPIDTOsResponsesDrugStoreLandingResponse>({root:"items",url:"/api/v1/items/landing" }),

    deleteItemsOfbusines: async ({businessId}:deleteItemsOfbusinesParams) => 
                 Builder.DELETE({root:"items",url:"/api/v1/items/ofbusiness/${businessId}" }),

    post_ItemsImages: async () => 
                 Builder.POST_Cashed({root:"items",url:"/api/v1/items/images" }),
    ...
    delete_ItemsOfbusinessAll: async ({id}:delete_ItemsOfbusinessAllParams) => 
                 Builder.DELETE({root:"items",url:"/api/v1/items/ofbusiness/${id}/all" }),
 } 
...
export const getItemsOfownerPagenatedClient = Builder.Offset_Load_Cashed<LoadItemsOfownerParams,LoadItemsOfownerResponse>
                                ({url:"/api/v1/items/ofowner"})
export const getItemsPagenatedClient = Builder.Offset_Load_Cashed<LoadItemsParams,LoadItemsResponse>
                                ({url:"/api/v1/items"})
